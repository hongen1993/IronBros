const Game = {
    ...
    generatePlatforms() {
        this.platforms.push(
            ...
            new Platform(this.ctx, this.posX, this.posY, 2700, 230, 1000, 70),
    ...
    generateCoins() {
        this.coins.push(
            ...
            new Coin(this.ctx, this.width, this.height, 2730, 170),
            new Coin(this.ctx, this.width, this.height, 2795, 170),
            new Coin(this.ctx, this.width, this.height, 2860, 170),
            new Coin(this.ctx, this.width, this.height, 2925, 170),
            new Coin(this.ctx, this.width, this.height, 2990, 170),
            new Coin(this.ctx, this.width, this.height, 3055, 170),
            new Coin(this.ctx, this.width, this.height, 3120, 170),

            new Coin(this.ctx, this.width, this.height, 3185, 170),
            new Coin(this.ctx, this.width, this.height, 3250, 170),
            new Coin(this.ctx, this.width, this.height, 3315, 170),
            new Coin(this.ctx, this.width, this.height, 3380, 170),
            new Coin(this.ctx, this.width, this.height, 3445, 170),
            new Coin(this.ctx, this.width, this.height, 3510, 170),
            new Coin(this.ctx, this.width, this.height, 3575, 170),
            new Coin(this.ctx, this.width, this.height, 3640, 170),

            new Coin(this.ctx, this.width, this.height, 3710, 170),
            new Coin(this.ctx, this.width, this.height, 3770, 170),
            new Coin(this.ctx, this.width, this.height, 3710, 240),
            new Coin(this.ctx, this.width, this.height, 3770, 240),
